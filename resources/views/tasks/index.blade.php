    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-block table-responsive p-4" style="min-height: 260px">
                                    ...
                                    <td class="p-1">
                                        <div class="btn-group d-flex justify-content-center align-items-center">
                                            ...
                                            <ul class="dropdown-menu">
                                                @if($task->status!= 'CO')
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('tasks.completed', $task->id) }}">
                                                            <i class="fa-solid fa-check mr-4 text-dark"></i>
                                                            Completar
                                                        </a>
                                                    </li>
                                                @endif
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h4>
                        Tareas
                        <span class="badge bg-primary text-white">{{ $tasks_pr->total() }}</span>
                    </h4>
